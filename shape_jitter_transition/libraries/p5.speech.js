// MK custom additions to p5.js-speech
// added callback bindings for onspeechstart (speechStart) and onspeechend (speechEnd)
...
// =============================================================================
  ...
  p5.SpeechRec = function(_lang, _callback) {
    ...
    // MK custom additions
    this.onSpeechStart; // Fired when the speech that will be used for speech recognition has started.
    this.onSpeechEnd; // Fired when the speech that will be used for speech recognition has ended.
