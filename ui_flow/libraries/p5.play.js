...
*/
//MK
p5.prototype.animation = function(anim, x, y, w, h) {
  anim.draw(x, y, w, h);
};
...
function Animation(pInst) {
  ...
  */
  ...
  this.draw = function(x, y, w, h, r) {
    this.xpos = x;
    this.ypos = y;
    this.w = w || this.images[frame].width;
    this.h = h  || this.images[frame].height;
    this.rotation = r || 0;
    ...
    if (this.visible)
    {
      ...
      if(this.images[frame] !== undefined)
      {
        if (this.spriteSheet) {
          ...
          pInst.image(this.images[frame], this.offX, this.offY, this.w, this.h);
        }
      }
      else
      {
  ...
  */
  ...
  // MK
   this.resize = function(s) {
     let scaleFactor = (s / this.images[0].height);
     for (let i=0; i<this.images.length; i++) {
       this.images[i].height = this.images[i].height*scaleFactor;
       this.images[i].width = this.images[i].width*scaleFactor;
     }
  };
